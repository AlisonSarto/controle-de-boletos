<?php
  ...
  $sql = "SELECT * FROM boletos WHERE n_boleto = '$n_boleto' AND id != $id";
  $res = $conn->query($sql);
  ...
  //* Atualiza o boleto
  $sql = "UPDATE boletos SET recebedor_id = $recebedor_id, recebedor_conta_id = $recebedor_conta_id, pagador_id = $pagador_id, pagador_conta_id = $pagador_conta_id, valor = $valor, n_boleto = '$n_boleto', data_vencimento = '$data_vencimento', taxa_emissao = $taxa_emissao, taxa_antecipacao = $taxa_antecipacao, total_a_receber = $total_a_receber WHERE id = $id";
  $res = $conn->query($sql);
